// src/jskos/context.ts

/**  
 * A single term mapping in a JSON-LD context  
 * (either a simple string – the namespace URI –  
 * or a full object with @id, @type, @container, etc.)
 */
export type JsonLdTerm =
  | string
  | {
      /** the IRI this term expands to */
      "@id"?: string;
      /** the RDF datatype or “@id” */
      "@type"?: string;
      /** how multiple values are collected */
      "@container"?: "@set" | "@list" | "@language";
      /** reverse property link */
      "@reverse"?: string;
      /** nested context or external context IRI */
      "@context"?: string | Record<string, unknown>;
    };

/**  
 * The full JSKOS JSON-LD context mapping  
 * you can import and use throughout your app.
 */
export const jskosContext: Record<string, JsonLdTerm> = {
  uri: "@id",
  type: {
